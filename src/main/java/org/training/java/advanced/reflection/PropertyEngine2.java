...
public class PropertyEngine2 {

    public static void fillProperty(Object obj) throws Exception {
        Class<?> aClass = obj.getClass();
        PropConf propFile = aClass.getAnnotation(PropConf.class);
        if (propFile != null) {
            Properties properties = new Properties();
            String value = propFile.file();
            String prefix = propFile.prefix();
            ...
            for (Field field : declaredFields) {
                ...
                String propKey = prefix + "." + fieldName;
